            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-gt-ink-secondary">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="rounded-md text-sm text-gt-muted underline hover:text-gt-ink focus:outline-none focus:ring-2 focus:ring-gt-accent-ring focus:ring-offset-2 focus:ring-offset-gt-raised"
                    >
