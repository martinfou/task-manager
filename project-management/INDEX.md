...
- [Sprint 6 — Trust, commands, mobile (active)](sprints/sprint-06-google-tasks-trust-commands-mobile.md) — **US-027–US-036** assigned (**91** pts); US-029 undo toast in progress — see sprint doc for capacity / replan note
