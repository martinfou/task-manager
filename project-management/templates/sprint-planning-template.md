...
compatible_with: [user-story, defect, product-backlog]
...
**Risks & Blockers** (see [escalation-process.md](../processes/escalation-process.md), [risks.md](../backlog/risks.md)):
- [Risk/Blocker 1]
- [Risk/Blocker 2]
...
**Sprint Review Notes** (see [sprint-review-process.md](../processes/sprint-review-process.md)):
- [Notes from sprint review meeting]
- [Done features demonstrated]
- [Feedback received]
...
- **Retrospective improvements for next sprint**
  - [Retrospective improvement 1]
  - [Retrospective improvement 2]
...
- **Acceptance criteria verification**: For each completed item, confirm all acceptance criteria are met and marked complete in the item file
